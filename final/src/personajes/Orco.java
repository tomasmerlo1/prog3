...
public class Orco extends Personaje {
    ...
    public Orco(String nombre, String apodo, String fechaNacimiento, int edad,
                int salud, int velocidad, int destreza, int fuerza,
                int nivel, int armadura) {
        super(nombre, apodo, "Orco", fechaNacimiento, edad, salud, velocidad, destreza, fuerza, nivel, armadura);
    }
    ...
    public double calcularDanio(Personaje defensor) {
        ...
        double danio = ((valorAtaque - poderDefensa) / 500) * 100 * 1.1;
